<template>
  <div class="BreakPage p-pos">
    ...
    <p>A01_101_110321_VE<br/><span style="color: transparent">vinmec</span></p>
    </div>
              ...
              <tr>
                ...
                <td>
                  <div class="text-center" style="font-size: 16pt; text-transform: uppercase;">
                    <div class="text-center"><b>PHIẾU XÉT NGHIỆM SINH THIẾT TỨC THÌ</b></div>
                    <div class="text-center"><b>FROSEN SECTION REQUEST</b></div>
                  </div>
                </td>
                <td>
        ...
        <tr>
          <td>
            <table width="100%">
              ...
              <tr>
                <td colspan="3"><p>Nhận xét bệnh phẩm/ <i>Sample description</i>: {{data.Pathology.GrosDescription}}</p></td>
              </tr>
              <tr>
