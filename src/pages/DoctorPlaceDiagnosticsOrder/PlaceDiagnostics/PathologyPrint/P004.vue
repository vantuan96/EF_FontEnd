<template>
  <div class="BreakPage p-pos">
    ...
    <p>A01_102_110321_VE<br/><span style="color: transparent">vinmec</span></p>
    </div>
              ...
              <tr>
                ...
                <td>
                  <div class="text-center" style="font-size: 16pt; text-transform: uppercase;">
                    <div class="text-center"><b>PHIẾU XÉT NGHIỆM MÔ BỆNH HỌC</b></div>
                    <div class="text-center"><b>HISTOPATHOLOGY REQUEST</b></div>
                  </div>
                </td>
                <td>
        ...
        <tr>
          <td>
            <table width="100%">
              ...
              <tr>
                <td colspan="3"><p>Phương pháp phẫu thuật/ <i>Procedure</i>: {{data.Pathology.SurgeryMethod}}</p></td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="3"><p>Thời gian mẫu được cố định/ <i>Fixative time</i>: {{data.Pathology.TimeOfStore}}</p></td>
              </tr>
              <tr>
                <td colspan="3"><p>Định hướng mẫu bệnh phẩm/ <i>Specimen orientation</i>: {{data.Pathology.SpecimenOrientation}}</p></td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="3"><p>Nhận xét đại thể khi lấy sinh thiết/ <i>Gross features</i>: {{data.Pathology.GrosDescription}}</p></td>
              </tr>
              <tr>
