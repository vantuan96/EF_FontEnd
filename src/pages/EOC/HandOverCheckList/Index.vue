  ...
  <div class="main-content" id="etr-page">
    ...
    <div v-if="!loading && IsUseHandOverCheckList">
        ...
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane active" id="tab1">
            <div class="box-table">
              ...
              <div class="box-table-content">
                ...
                <p>{{__t('Thăm khám')}}: {{data.ClinicalExaminationAndFindings}}</p>
              ...
              <div class="">
                <table class="table table-bordered padding-td">
                  <tr>
                    ...
                    <td width="33%">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" :value="__label(data.HandOverUnitPhysician)" readonly>
                      </div>
                      <div class="form-group">
                      ...
                      <div :class="{'min-h-60': !data.UserNameHandOverPhysician}">
                        <div v-if="data.UserNameHandOverPhysician" class="text-center">
                          ...
                          <div class="fw600">{{data.HandOverPhysician.Fullname}}</div>
                        </div>
                      </div>
                    </td>
                    <td width="33%">
                      <div class="form-group">
                        <label>{{__t('Nơi nhận')}}</label>
                  ...
                  <!-- <tr v-else>
                    ...
                    <td width="33%">
                      ...
                      <div class="form-group">
                        <label>{{__t('PHR.ho_va_ten_bac_si')}}</label>
                        <input type="text" class="form-control" v-if="data.HandOverPhysician" :value="data.HandOverPhysician.Fullname" readonly>
                      </div>
                    </td>
                    <td width="33%">
                      <div class="form-group">
                ...
                <div class="tabs-footer">
                  ...
                  <button class="btn btn-back pull-right btn-info" type="button" v-shortkey="['ctrl', 'p']" @shortkey="print()" @click="print()"><i class="fa fa-print" aria-hidden="true"></i>{{__t('In')}}</button> -->
                </div>
                <FloatBlock>
          ...
          <div role="tabpanel" class="tab-pane" id="tab2" v-if="DataSubmit">
            <div class="box-table">
                ...
                <tr>
                  <td width="33%" style="vertical-align: top;">
                    <div class="form-group">
                      ...
                      <v-date-picker :readonly="viewOnly" class="full-w" :format="vDateTimeFormat" v-model="data.HandOverTimeNurse"/>
                    </div>
                  </td>
                  <td width="33%">
                    <div class="form-group">
                      <label>{{__t('PHR.noi_ban_giao')}}</label>
                      <input type="text" class="form-control" v-model="data.HandOverUnitNurse" readonly>
                    </div>
                    <div class="form-group">
                      <label>{{__t('PHR.nguoi_ban_giao')}}</label>
                    </div>
                    <div :class="{'min-h-60': !data.UserNameHandOverNurse}">
                      <div v-if="data.UserNameHandOverNurse" class="text-center">
                        <div class="italic">{{data.HandOverTimeNurse | formatDateWithoutSecon}}</div>
                        <div class="flex align-center" style="margin-left: 90px;">
                          <div class="fw600 mrr5">
                            <ad-Info class="fw600" :ad="data.UserNameHandOverNurse" />
                          </div>
                          <div class="italic fw400" style="color: green">({{__t('Đã ký xác nhận')}})</div>
                        </div>
                        <div class="fw600">{{data.HandOverPhysician.Fullname}}</div>
                  ...
                  <td width="33%">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" v-model="data.ReceivingUnitNurse" readonly>
                    </div>
                    <div class="form-group">
                      <label>{{__t('PHR.nguoi_nhan_ban_giao')}}</label>
                    </div>
                    <div :class="{'min-h-60': !data.UserNameReceivingNurse}">
                      <div v-if="data.UserNameReceivingNurse" class="text-center">
                        <div class="italic">{{data.NurseAcceptTime}}</div>
                        <div class="flex align-center" style="margin-left: 90px;">
                          <div class="fw600 mrr5">
                            <ad-Info class="fw600" :ad="data.UserNameReceivingNurse" />
                          </div>
                          <div class="italic fw400" style="color: green">({{__t('Đã ký xác nhận')}})</div>
                        </div>
                        <div class="fw600">{{data.ReceivingNurse}}</div>
                      </div>
                    </div>
                  </td>
                </tr>
              ...
              <div class="tabs-footer">
                <!-- <button class="btn v-white-btn" type="button" @click="back">{{__t('Quay lại')}}</button>
                <button class="btn v-yellow-btn pull-right long-btn" type="button" v-shortkey="['ctrl', 's']" @shortkey="save()" @click="save()"><i class="fa fa-floppy-o" aria-hidden="true"></i> {{__t('Lưu')}}</button>
                <button class="btn btn-back pull-right btn-info" type="button" @click="print()">In</button> -->
              </div>
              <FloatBlock>
                <template slot='buttons'>
                  <div class="col-md-4">
                  ...
                  <div class="col-md-8">
                    <div class="form-group1">
                      <button class="btn v-yellow-btn pull-right long-btn" type="button" v-shortkey="['ctrl', 's']" @shortkey="save()" @click="save()">{{__t('btn.save')}}</button>
                    </div>
                  </div>
                </template>
              </FloatBlock>
      ...
      <div v-else class="text-center">
        <h4>{{__labelMsg(msgError)}}</h4>
        <p><button v-if="msgError.NeedNew" class="btn btn-back v-white-btn" type="button" @click="confirmPopup()">{{__t('Tạo mới')}}</button></p>
      </div>
  ...
  methods: {
    ...
    save () {
      ...
      setTimeout(() => {
        ...
        new HandOverCheckList().update('update/' + this.$route.params.Id, DataSubmit).then(response => {
          this.toastedSuccess()
          this.edited = false
        })
      }, 100)
    ...
    create () {
      new HandOverCheckList().update('create/' + this.$route.params.Id, {}).then(response => {
        this.reload()
      })
    },
    getData () {
