<template>
  <div class="a4-page box has-translation" :id="printId || 'printMe'" v-if="tmp">
    ...
    <div v-if="checkHide()">
      <p @dblclick="addBreakPage" class="hasBreakPage" style="margin: 7px 0;font-size: 14px;line-height: 1.5;"><b>Ngày hẹn trả KQ</b>/ <i>The return date results: </i>{{(dataParent.AppointmentDateResult ? dataParent.AppointmentDateResult : dataParent.AppointmentDateResult) | formatDateWithoutSecon}}</p>
    </div>
    <div>
    </div>
    <table width="100%">
      <tr>
        ...
        <td width="50%" style="text-align: center;">
          ...
          <p v-else style="text-align: center; font-size: 14px;"><b>Ngày</b>/ <i>Date: </i>{{(dataParent.Date ? dataParent.Date : data.Date)}}</p>
...
export default {
  ...
  methods: {
    getListConfirm (val) {
      ...
      console.log('getListConfirm ~ this.MEDICALREPORT_PHY_TIME', this.MEDICALREPORT_PHY_TIME)
    },
    OPDOENBMIlabel () {
