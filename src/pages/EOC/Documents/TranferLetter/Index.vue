  ...
  <div class="main-content" id="di0-page">
    ...
    <div class="a4-page box" id="printMe">
      ...
      <div class="font15">
        ...
        <template v-if="HealthInsuranceNumber">
          <p>- Số thẻ/ <i>HI no.</i>:</p>
          <table class="tbl-b" style="margin-bottom: 5px; width: auto">
            <tr>
              <td style="padding: 5px 15px;">{{HealthInsuranceNumber[0]}}</td>
              <td style="padding: 5px 15px;">{{HealthInsuranceNumber[1]}}</td>
              <td style="padding: 5px 15px;">{{HealthInsuranceNumber[2]}}</td>
              <td style="padding: 5px 15px;">{{HealthInsuranceNumber[3]}}</td>
            </tr>
          </table>
        </template>
        <template v-else>
          ...
          <table class="tbl-b" style="margin-bottom: 5px; width: auto">
            <tr>
              <td style="padding: 5px 15px;"><span class="hidden-box">xx</span></td>
              <td style="padding: 5px 15px;"><span class="hidden-box">x</span></td>
              <td style="padding: 5px 15px;"><span class="hidden-box">xx</span></td>
              <td style="padding: 5px 15px;"><span class="hidden-box">xxxxxxxxxxxx</span></td>
            </tr>
          </table>
        </template>
        <p class="no-wrap-hidden">- Hạn sử dụng/ <i>Health of issurance valid to date</i>: {{data.ExpireHealthInsuranceDate || '. . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .'}}</p>
        <p>Đã được khám bệnh/ điều trị:</p>
        ...
        <div>
          <p v-if="data.Version !== 2" @dblclick="addBreakPage" class="hasBreakPage" style="margin: 7px 0;font-size: 15px;line-height: 1.5;"><b>Khám lâm sàng</b>/ <i>Clinical examination and findings: </i>: {{data.ClinicalExaminationAndFindings}}</p>
        </div>
        ...
        <div v-if="data.Version === 2">
          ...
          <div style="padding-left: 5px;">
            <p style="margin: 7px 0;font-size: 14px;line-height: 1.5;">+ <span v-if="data.DataOenVersion2[2]" class="font15">Khám toàn thân/<i> Body physical examination: </i>{{data.DataOenVersion2[2].Value}}</span></p>
            <p style="margin: 7px 0;font-size: 14px;line-height: 1.5;">+ <span v-if="data.DataOenVersion2[0]" class="font15">Khám chuyên khoa/<i> Subspecialty examination: </i>{{data.DataOenVersion2[0].Value}}</span></p>
            <p style="margin: 7px 0;font-size: 14px;line-height: 1.5;">+ <span v-if="data.DataOenVersion2[1]" class="font15">Khám tim mạch, hô hấp/<i> Respiratory and cardiac function: </i>{{data.DataOenVersion2[1].Value}}</span></p>
            <p style="margin: 7px 0;font-size: 14px;line-height: 1.5;">+ <span v-if="data.DataOenVersion2[3]" class="font15">Khám các bộ phận khác (nếu có)/<i> Examination of other related areas (if any): </i>{{data.DataOenVersion2[3].Value}}</span></p>
          </div>
        </div>
        <p @dblclick="addBreakPage" class="hasBreakPage">- Kết quả xét nghiệm, cận lâm sàng/ <i>Lab test and paraclinical test result</i>: {{data.PrincipalTest ? ('\n' + data.PrincipalTest) : '. . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .'}}</p>
        <p @dblclick="addBreakPage" class="hasBreakPage">- Chẩn đoán/ <i>Diagnosis</i>: {{data.Diagnosis || '. . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .'}}</p>
        <p @dblclick="addBreakPage" class="hasBreakPage">- Phương pháp, thủ thuật, kỹ thuật, thuốc đã sử dụng trong điều trị/ <i>Method, procedure, technique, medication applied during treatment</i>: {{data.Method || '. . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .'}}</p>
        ...
        <p @dblclick="addBreakPage" class="hasBreakPage">- Hướng điều trị/ <i>Treatment plan</i>: {{data.TreatmentPlans || '. . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .'}}</p>
        <p @dblclick="addBreakPage" class="hasBreakPage">- Chuyển tuyến hồi/ <i>Transfer Date</i>: <template v-if="data.Date">{{data.Date | bilingualFormatDateTime}}</template><template v-else>. . . . . . . . . giờ . . . . . . . . . phút, ngày . . . . . . . . . tháng . . . . . . . . . năm . . . . . . . . .</template></p>
      ...
      <table width="100%">
        ...
        <tr :class="{'only-print-page': data.VisitVersion >= 10}">
        ...
        <tr :class="{'only-print-page': data.VisitVersion >= 10}">
          <td valign="top">
            ...
            <p v-if="TRANSFERLETTER_PIC && data.VisitVersion >= 10" style="text-align: center;">{{TRANSFERLETTER_PIC}}</p>
            <p v-else-if="data && data.VisitVersion < 10" style="text-align: center;">{{(data.Physician)}}</p>
          </td>
          <td valign="top">
            <p style="text-align: center;" class="font15">(Ký tên, đóng dấu/ <i>Sign, stamp</i>)</p>
            <img style="opacity: 0" class="hidden-box" src="/static/140x80.png" />
    ...
    <div class="a4-page no-style" v-if="data.Translations && data.Translations.length && !viewOnly">
      ...
      <div class="a4-page translation-area" v-if="!viewOnly">
        <translation-request :name="'giấy chuyển tuyến'" :VisitId="_VisitId" :ViName="'GIẤY CHUYỂN TUYẾN'" :EnName="'TRANSFER LETTER'" />
      </div>
...
export default {
  ...
  methods: {
    ...
    getData () {
      new Document().find('TransferLetter/' + this._VisitId).then(response => {
