<template>
  <Vcollapse @getData="getData()" ref="Vcollapse">
    ...
    <template slot='content' v-if="hasData">
      <MedicalOutpatient :viewOnly="true" :VisitId="_VisitId" :VisitType="_VisitType"/>
    </template>
  </Vcollapse>
</template>
<script>
import MedicalOutpatient from '@/pages/OPD/MedicalRecordForOutpatient/Index.vue'

export default {
  name: 'ViewMedicalRecordForOutpatient',
