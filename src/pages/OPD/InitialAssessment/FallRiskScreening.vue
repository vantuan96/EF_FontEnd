        ...
        <td colspan="4">
          <div class="row">
            <div class="col-sm- col-md-6">
              <button class="btn btn-block v-white-btn" @click="back()">Quay Lại</button>
            </div>
            <div class="col-sm- col-md-6">
              <button class="btn btn-block v-yellow-btn" @click="save()">Lưu</button>
            </div>
          </div>
        </td>
      </tr> -->
...
export default {
  ...
  computed: {
    ...
    allowEdit () {
      return this.DataSubmit.Username === this.$store.state.account.Username || this.ImSuperAdmin() || !this.IsFormLocked(this.DataSubmit)
    }
  },
  mounted () {
  },
