        ...
        <template slot="top" v-if="!isReadOnlyStatus">
          ...
          <div class="group-radio mt-5" v-if="MASTERDATA['PRANCO321'].Items" width="25%">
            <template  v-for="(status, index) in MASTERDATA['PRANCO321'].Items">
              <input :class="{'readonlyTest': checkLockFloat}" v-if="status.DataType === 'Radio' && index === 0" :data="status" :key="index" type="checkbox" :id="'a' + index" name="status" v-model="status.Value" @click="checkbox2RadioNotAllowNull(MASTERDATA['PRANCO321'].Items, status)">
            ...
            <template  v-for="(status, index) in MASTERDATA['PRANCO321'].Items" style="pointer-events: none">
              <input :class="{'readonlyStatus': checkLockChange}" v-if="status.DataType === 'Radio' && index === 1" :data="status" :key="index" type="checkbox" :id="'a' + index" name="status" v-model="status.Value" @click="checkbox2RadioNotAllowNull(MASTERDATA['PRANCO321'].Items, status)">
            ...
            <template  v-for="(status, index) in MASTERDATA['PRANCO321'].Items" style="pointer-events: none">
              <input :class="{'readonlyTest': checkLockFloat}" v-if="status.DataType === 'Radio' && index === 2" :data="status" :key="index" type="checkbox" :id="'a' + index" name="status" v-model="status.Value" @click="checkbox2RadioNotAllowNull(MASTERDATA['PRANCO321'].Items, status)">
            ...
            <template  v-for="(status, index) in MASTERDATA['PRANCO321'].Items" >
              <input :class="{'readonlyStatus': checkLockChange}" v-if="status.DataType === 'Radio' && index === 3 && dataCheck === 0" :data="status" :key="index" type="checkbox" :id="'a' + index" name="status" v-model="status.Value" @click="checkbox2RadioNotAllowNull(MASTERDATA['PRANCO321'].Items, status)">
...
export default {
  ...
  methods: {
    ...
    checkStatusPatient () {
      ...
      if (this.DataSubmit) {
        if (this.DataSubmit.StatusCode === 'OPDIH') {
          ...
          this.statusPatient = this.__t('NB chờ KQXN')
      ...
      if (this.isOnClick === true) {
        ...
        if (this.MASTERDATA['PRANCO226'].Items[0].Value === false && this.MASTERDATA['PRANCO226'].Items[1].Value === true) {
          ...
          if (this.DataSubmit.StatusCode !== null) {
            if (this.DataSubmit.StatusCode === 'OPDNE' && this.hasSave === 2) {
            ...
            } else if (this.DataSubmit.StatusCode === 'OPDIH' && this.hasSave === 2 && this.isAccept !== true) {
              this.MASTERDATA['PRANCO321'].Items[0].Value = true
            ...
            if (this.DataSubmit.StatusCode === 'OPDWR' && this.hasSave === 2) {
            ...
            if (this.DataSubmit.StatusCode === 'OPDDC' && this.hasSave === 2 && this.isAccept !== true) {
    ...
    // handleTestRadio (val) {
    //   console.log(this.checkChooseYes, this.checkChooseNo, this.MASTERDATA['PRANCO226'].Items[1].Value, this.MASTERDATA['PRANCO226'].Items[0].Value, 'check handleTestRadio')
    //   if (this.MASTERDATA['PRANCO226'].Items[1].Value === true) {
    //     this.isOnClick = true
