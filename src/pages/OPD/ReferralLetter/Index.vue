<template>
  <div class="main-content" id="di0-page">
    ...
    <modal :name="'view-modal'" transition="pop-out" height="auto" :scrollable="false" :width="modalWidth" :class="'no-scroll-x'">
      ...
      <div v-else>
        <ReferralLetterView :dataParent="data" :isTranView="true" :PkntVersion="data.PkntVersion" :data="dataTranslated" v-if="dataTranslated" :printId="'printview'" :site="'OPD'" :Status="Status"/>
