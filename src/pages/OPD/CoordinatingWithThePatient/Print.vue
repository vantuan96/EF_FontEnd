<template>
 <div class="a4-page box" id="printMe" v-if="DataSubmit">
  <table width="100%">
   <tr>
    ...
    <td class="text-center">
     <div class="font20 font-bold text-center" style="text-align: center">BIÊN BẢN/ REPORT</div>
     <div class="font14 text-center" style="font-style: italic;text-align: center">
      (Phối hợp với bệnh nhân/ gia đình xử lý thai chết lưu/ Coordinating with the patient/ family to deal with a stillbirth)
     </div>
    </td>
    <!--
  ...
  <div class="box form-content">
   ...
   <!-- địa điểm -->
    <p class="text-bold font16">
     ...
     <a>{{$store.state.account.Specialty.ViName}}</a>
    </p>
    <p class="text-bold font16">
      <a style="font-weight: bold">III. Thành phần tham dự/ Participants </a>
    </p>
    <a style="font-weight: bold; margin-left:10px">1. Bệnh viện/ Hospital</a>
  ...
  <p style="font-weight: bold; margin-left:10px; margin-top:20px">2. Người bệnh/ Gia đình người bệnh (ghi rõ mối quan hệ)/ Patient/ Patient's family (specify relationship):</p>
  ...
  <div class="box form-content" style="margin-top:20px">
   ...
   <p>
    ...
    ><span class="tab404">{{getItemDate(Customer.AdmittedDate) || 'N/A'}}</span>
   </p>
   <p class="text-bold font16">
   ...
   <div v-if="showItems1" style="margin-bottom:10px">
    ...
    <div style="display: flex;">
    <div style="margin-left:20px">
      <p>{{MASTERDATA['IPDIAACOORDIXNKK1'].Items[0].Value ? '&#9745;' : '&#9744;'}} Đồng ý/ Agreee</p>
    </div>
    <div style="margin-left:10px">
