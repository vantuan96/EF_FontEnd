<template>
  <Vcollapse @getData="getData()" ref="Vcollapse">
    ...
    <template slot='content' v-if="hasData">
      <div class="wap-table">
        <observation-table :VisitId="VisitId || this.$route.params.Id" :Type="'ED'"/>
      </div>
      <div class="wap-table">
        <patient-progress-notes :VisitId="VisitId ||  this.$route.params.Id" :Type="'ED'"/>
      </div>
    </template>
  </Vcollapse>
</template>
...
import PatientProgressNotes from '@/components/PatientProgressNotesView.vue'
