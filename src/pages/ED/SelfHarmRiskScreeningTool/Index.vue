    ...
    <template v-if="loaded">
      ...
      <div class="sync-ed-box" v-if="DataSubmit">
        <table class="standing-order-tbl">
          <tr>
            <td class="bg-head b-b-2" colspan="2"><label class="mr-5">{{__t('Thời gian sàng lọc')}}: </label><VDateTimePicker :readonly="isReadonly" :noclearable="true" :hideTooltip="true" class="w1510 display-inline" :format="'HH:mm DD/MM/YYYY'" v-model="DataSubmit.ScreeningTime"/></td>
            <td colspan="3">
              <template v-if="syncDatas">
                <button class="btn btn-sync-data pull-right" @click="syncData()">{{__t('Lấy dữ liệu đánh giá gần nhất')}}</button>
              </template>
            </td>
          </tr>
          <tr>
            <td class="bg-head font-bold" width="20px">
              {{__t('STT')}}
            </td>
          ...
          <tr v-if="MASTERDATA['EDSHRSTIHDE']">
            ...
            <td class="text-center">
              <MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[0]" v-model="MASTERDATA['EDSHRSTIHDE']"/>
            </td>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[1]" v-model="MASTERDATA['EDSHRSTIHDE']"/></td>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[2]" v-model="MASTERDATA['EDSHRSTIHDE']"/></td>
            </template>
          </tr>
          <tr v-if="MASTERDATA['EDSHRSTIHYU']">
            ...
            <template v-else>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[0]" v-model="MASTERDATA['EDSHRSTIHYU']"/></td>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[1]" v-model="MASTERDATA['EDSHRSTIHYU']"/></td>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[2]" v-model="MASTERDATA['EDSHRSTIHYU']"/></td>
            </template>
          </tr>
          <tr v-if="MASTERDATA['EDSHRSTIWWHY']">
            ...
            <template v-else>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[0]" v-model="MASTERDATA['EDSHRSTIWWHY']"/></td>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[1]" v-model="MASTERDATA['EDSHRSTIWWHY']"/></td>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[2]" v-model="MASTERDATA['EDSHRSTIWWHY']"/></td>
            </template>
          </tr>
          <tr v-if="MASTERDATA['EDSHRSTHYET']">
            ...
            <template v-else>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[0]" v-model="MASTERDATA['EDSHRSTHYET']"/></td>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[1]" v-model="MASTERDATA['EDSHRSTHYET']"/></td>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[2]" v-model="MASTERDATA['EDSHRSTHYET']"/></td>
            </template>
          </tr>
          ...
          <tr>
            <td colspan="4">
              ...
              <MdRextarea :readonly="isReadonly" v-model="MASTERDATA['EDSHRST0IYH'].Items[0]"/>
            </td>
          </tr>
          <tr>
            <td colspan="4">
          ...
          <tr v-if="ifPatientAnswersYes" id="EDSHRSTAYGY">
            <td :rowspan="MASTERDATA['EDSHRSTAYGY'].Items[2].Value || MASTERDATA['EDSHRSTAYGY'].Items[0].Value ? 2 : 1">5</td>
            <td>{{__label(MASTERDATA['EDSHRSTAYGY'])}} <span required>*</span></td>
            <td v-if="isReadonly" colspan="2" class="text-center">
            <MDRadioView :data="MASTERDATA['EDSHRSTAYGY'].Items" />
            </td>
            <template v-else>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[0]" v-model="MASTERDATA['EDSHRSTAYGY']"/></td>
            <td class="text-center"><MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[1]" v-model="MASTERDATA['EDSHRSTAYGY']"/></td>
            <td class="text-center">
              <MDRadio @onChange="setIPDIAAUITV2()" :noFlex="true" :indexs="[2]" v-model="MASTERDATA['EDSHRSTAYGY']"/>
            </td>
            </template>
          </tr>
          <tr v-if="MASTERDATA['EDSHRSTAYGY'].Items[2].Value || MASTERDATA['EDSHRSTAYGY'].Items[0].Value">
            <td colspan="4">
              {{__t('Nhập lý do')}}:
              <MdRextarea :readonly="isReadonly" v-model="MASTERDATA['EDSHRSTAYGY'].Items[3]"/>
            </td>
          </tr>
          <tr>
            <td colspan="5">
              <b>{{__label(MASTERDATA['EDSHRST00SR'])}}:</b> <MDRadio :readonly="true" v-model="MASTERDATA['EDSHRST00SR']"/>
            </td>
          </tr>
          <tr>
            <td colspan="5">
              <p><i>{{__label(MASTERDATA['EDSHRSTNOTE1'])}}</i></p>
              <p><i>{{__label(MASTERDATA['EDSHRSTNOTE2'])}}</i></p>
            </td>
          </tr>
        </table>
        <br/>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 text-center">
            ...
            <template v-else>
              ...
              <p><button @click="showDoctorConfirm()" class="btn v-white-btn">{{__t('Xác nhận')}}</button></p>
            </template>
          </div>
        </div>
        <br/>
...
export default {
  ...
  methods: {
    ...
    setIPDIAAUITV2 () {
      setTimeout(() => {
        if (this.MASTERDATA['EDSHRSTHYET'].Items[1].Value) {
          // this.MASTERDATA['EDSHRSTAYGY'].Items[0].Value = false
          // this.MASTERDATA['EDSHRSTAYGY'].Items[1].Value = false
        }
      }, 100)
      setTimeout(() => {
    ...
    create () {
      new SelfHarmRiskScreeningTool().update('/Create/' + this.$route.params.Id, {}).then(response => {
        this.reload()
      }).catch(e => {
        // this.back()
      })
    ...
    getSyncData () {
      new SelfHarmRiskScreeningTool({hidemsg: true}).find('Sync/' + this.DataSubmit.Id).then(response => {
    ...
    getData () {
      new SelfHarmRiskScreeningTool({hidemsg: true}).find(this._VisitId).then(response => {
    ...
    async submit () {
      ...
      await new SelfHarmRiskScreeningTool().update('/Update/' + this.$route.params.Id, DataSubmit).then(response => {
        this.toastedSuccess()
        this.getData()
      }).catch(e => {
    ...
    async confirm () {
      await this.submit()
      new SelfHarmRiskScreeningTool().update('/Confirm/' + this.$route.params.Id, this.user).then(response => {
        this.reload()
