      ...
      <div class="main-content">
        <div class="v-tab v-tab-2" v-if="Lists.length">
          ...
          <div class="tab-content">
            <Item v-if="formId" :formId="formId" :VisitType="_VisitType" :viewOnly="true" :VisitId="_VisitId"/>
          </div>
        </div>
...
export default {
   ...
   */
  name: 'EDSelfHarmRiskScreeningTool',
  ...
  methods: {
    ...
    getData () {
      ...
      console.log('id', id)
      new SelfHarmRiskScreeningToolService().find('/All/' + id + '?hidemsg=' + true).then(response => {
