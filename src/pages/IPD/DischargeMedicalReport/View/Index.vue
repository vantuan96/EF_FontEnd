<template>
  <div class="main-content" id="di0-page">
      ...
      <p><b>Quá trình bệnh lý và diễn biến lâm sàng</b>/ <i>Clinical evolution</i>: {{data.ClinicalEvolution}}</p>
      ...
      <p @dblclick="addBreakPage" class="hasBreakPage"><b>Ngày hẹn tái khám</b>/ <i>Date of next appointment: </i>{{(data.DateOfNextAppointment && data.DateOfNextAppointment !== 'Invalid date') ? data.DateOfNextAppointment : ''}}</p>
      ...
      <table class="table hidden-only-form" style="width: 100%">
        <tr>
          <td width="40%" height="150" class="text-center" style="text-align: center" valign="top">
            ...
            <p v-if="data.PhysicianInCharge && data.PhysicianInCharge.Fullname" class="text-center">{{data.PhysicianInCharge.Fullname}}</p>
          ...
          <td width="30%" height="150" class="text-center" style="text-align: center" valign="top">
            ...
            <img style="opacity: 0" class="hidden-box" src="/static/140x80.png" />
            <p v-if="data.DeptHead && data.DeptHead.Fullname" class="text-center">{{data.DeptHead.Fullname}}</p>
            <p v-else class="text-center" style="text-align: center"><b>Họ tên</b>/ <i>Full name</i>:.............................</p>
          </td>
          <td width="30%" height="150" class="text-center" style="text-align: center" valign="top">
            <p><b>GIÁM ĐỐC/ </b><i>DIRECTOR</i></p>
            <img style="opacity: 0" class="hidden-box" src="/static/140x80.png" />
            <p v-if="data.Director && data.Director.Fullname" class="text-center">{{data.Director.Fullname}}</p>
            <p v-else class="text-center" style="text-align: center"><b>Họ tên</b>/ <i>Full name</i>:.............................</p>
          </td>
        </tr>
      </table>
