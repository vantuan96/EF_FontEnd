  ...
  <div class="main-content">
    <template v-if="loaded">
      <template v-if="DataSubmit">
        ...
        <br/>
        <br/>
        <div class="row" v-if="DataSubmit.Version >= 10">
          ...
          <div class="col-md-6 col-sm-6 text-center">
            <template v-if="DataSubmit.SecretaryTime">
                <p><b>{{__t('THƯ KÝ')}}:</b></p>
                <i>{{getFTime(DataSubmit.SecretaryTime)}}</i>
            ...
            <template v-if="DataSubmit.ChairmanTime">
                <p><b>{{__t('CHỦ TỌA')}}:</b></p>
                <i>{{getFTime(DataSubmit.ChairmanTime)}}</i>
...
export default {
  ...
  methods: {
    ...
    handleAddMember () {
      ...
      this.DataSubmit.Members.push(data)
    },
    handleDelete (index) {
      this.DataSubmit.Members.splice(index, 1)
    },
    icdChange (value) {
