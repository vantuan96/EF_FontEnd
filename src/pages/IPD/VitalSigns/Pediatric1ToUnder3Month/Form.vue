        ...
        <div class="content">
          ...
          <modal name="MasterDataPopup" transition="pop-out" height="auto" :clickToClose="false" :width="modalWidth">
            <div class="sync-ed-header">
              {{__t('PediatricVitalSigns.bigTitle')}} {{__t('(Từ 1 đến dưới 3 tháng tuổi)')}}
...
export default {
  ...
  methods: {
    ...
    getTongMews () {
      ...
      if (this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value !== null) {
        isNum = true
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 75) {
          num += 3
          this.BreathingPews = 3
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 74 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 65) {
          num += 2
          this.BreathingPews = 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 64 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 55) {
          num += 1
          this.BreathingPews = 1
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 54 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 40) {
          num += 0
          this.BreathingPews = 0
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 39 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 25) {
          num += 1
          this.BreathingPews = 1
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 24 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 20) {
          num += 2
          this.BreathingPews = 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 19) {
          num += 3
          this.BreathingPews = 3
        }
      }
      ...
      if (this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value !== null) {
        isNum = true
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 120) {
          num += 3
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 59 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 51) {
          num += 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 119 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 90) {
          num += 1
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 89 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 60) {
          num += 0
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 50) {
          num += 3
        }
      }
      // mach
      ...
      if (this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value !== null) {
        isNum = true
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 180) {
          num += 3
          this.BloodVesselPews = 3
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 179 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 170) {
          num += 2
          this.BloodVesselPews = 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 169 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 160) {
          num += 1
          this.BloodVesselPews = 1
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 159 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 90) {
          num += 0
      ...
      if (this.MASTERDATA['IPDPEWSPDT10'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT10'].Items[0].Value !== null) {
        ...
        if (this.MASTERDATA['IPDPEWSPDT10'].Items[0].Value <= 40.9 && this.MASTERDATA['IPDPEWSPDT10'].Items[0].Value >= 38.9) {
          num += 2
