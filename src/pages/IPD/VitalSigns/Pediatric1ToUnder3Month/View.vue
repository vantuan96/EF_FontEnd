<template>
  <Vcollapse @getData="getData()" ref="Vcollapse">
    ...
    <template slot='content' v-if="hasData">
      <Pediatric1ToUnder3Month :viewOnly="true" :VisitId="VisitId" :VisitType="_VisitType"/>
    </template>
  </Vcollapse>
</template>
<script>
import Pediatric1ToUnder3Month from './Index'

export default {
  name: 'IPDVitalSignFor1To3',
