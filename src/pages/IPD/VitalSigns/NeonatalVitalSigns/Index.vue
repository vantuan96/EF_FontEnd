<template>
  <div id="NeonatalVitalSigns-Page" class="main-content disable_ccp adult_vital_signs">
    <h3 class="text-center cap mrb30 fw600">{{__t('NeonatalVitalSigns.bigTitle')}}</h3>
    <div class="content-body">
      <Form :VisitId="VisitId" @hiddenLog="setHiddenLog" :viewOnly="viewOnly" @TimeLog="getTimeLog"/>
    </div>
     <div>
      <p>A02_030_080322_V</p>
    </div>
    <div v-if="hiddenLog">
