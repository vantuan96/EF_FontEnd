<template>
  <div id="Pediatric1ToUnder4Old-Page" class="main-content disable_ccp adult_vital_signs">
    <h3 class="text-center cap fw600">{{__t('PediatricVitalSigns.bigTitle')}}</h3>
    <h3 class="text-center mrb30 fw600">{{__t('(Từ 3 đến 12 tháng tuổi)')}}</h3>
    <div class="content-body">
      <Form :VisitId="VisitId" @hiddenLog="setHiddenLog" :viewOnly="viewOnly" @TimeLog="getTimeLog"/>
    </div>
     <div>
      <p>A02_035_080322_V</p>
    </div>
    <div v-if="hiddenLog">
