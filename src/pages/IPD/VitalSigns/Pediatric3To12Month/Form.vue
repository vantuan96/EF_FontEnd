        ...
        <div class="content">
          ...
          <modal name="MasterDataPopup" transition="pop-out" height="auto" :clickToClose="false" :width="modalWidth">
            <div class="sync-ed-header">
              {{__t('PediatricVitalSigns.bigTitle')}} {{__t('(Từ 3 đến 12 tháng tuổi)')}}
...
export default {
  ...
  methods: {
    ...
    getTongMews () {
      ...
      if (this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value !== null) {
        isNum = true
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 65) {
          num += 3
          this.BreathingPews = 3
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 64 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 60) {
          num += 2
          this.BreathingPews = 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 59 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 50) {
          num += 1
          this.BreathingPews = 1
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 49 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 30) {
          num += 0
      ...
      if (this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value !== null) {
        isNum = true
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 130) {
          num += 3
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 129 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 110) {
          num += 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 109 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 75) {
          num += 0
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 74 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 61) {
          num += 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 60) {
          num += 3
        }
      }
      // mach
      ...
      if (this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value !== null) {
        ...
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 159 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 100) {
          num += 0
          this.BloodVesselPews = 0
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 99 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 90) {
          num += 1
          this.BloodVesselPews = 1
        }
        ...
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 79) {
          num += 3
          this.BloodVesselPews = 3
        }
      }
