        ...
        <div class="content">
          ...
          <modal name="MasterDataPopup" transition="pop-out" height="auto" :clickToClose="false" :width="modalWidth">
            <div class="sync-ed-header">
              {{__t('PediatricVitalSigns.bigTitle')}} {{__t('(Từ 4 đến 12 tuổi)')}}
...
export default {
  ...
  methods: {
    ...
    getTongMews () {
      ...
      if (this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value !== null) {
        isNum = true
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 50) {
          num += 3
          this.BreathingPews = 3
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 49 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 35) {
          num += 2
          this.BreathingPews = 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 34 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 30) {
          num += 1
        ...
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 9) {
          num += 3
          this.BreathingPews = 3
        }
      }
      ...
      if (this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value !== null) {
        ...
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 149 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 125) {
          num += 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 124 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 110) {
          num += 1
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 109 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 90) {
          num += 0
        }
      ...
      if (this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value !== null) {
        ...
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 139 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 120) {
          num += 1
          this.BloodVesselPews = 1
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 119 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 80) {
          num += 0
        ...
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 69 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 60) {
          num += 2
          this.BloodVesselPews = 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 59) {
          num += 3
          this.BloodVesselPews = 3
        }
      }
