<template>
  <Vcollapse @getData="getData()" ref="Vcollapse">
    ...
    <template slot='content' v-if="hasData">
      <Pediatric1ToUnder4Old :viewOnly="true" :VisitId="VisitId" :VisitType="_VisitType"/>
    </template>
  </Vcollapse>
</template>
<script>
import Pediatric1ToUnder4Old from './Index'

export default {
  name: 'IPDVitalSignFor1To4',
