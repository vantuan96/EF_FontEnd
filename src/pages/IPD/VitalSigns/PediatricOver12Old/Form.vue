        ...
        <div class="content">
          ...
          <modal name="MasterDataPopup" transition="pop-out" height="auto" :clickToClose="false" :width="modalWidth">
            <div class="sync-ed-header">
              {{__t('PediatricVitalSigns.bigTitle')}} {{__t('(Trên 12 tuổi)')}}
                                ...
                                <table class="table observation-table table-dropdow" style="width: 500px">
                                  <thead>
                                    <tr>
                                      ...
                                      <th class="no-wrap">6-9</th>
                                      <th class="no-wrap">&#8804; 5</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    <tr>
                                ...
                                <table class="table observation-table table-dropdow" style="width: 500px; margin: 0">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <th class="no-wrap">60-69</th>
                                      <th class="no-wrap">50-59</th>
...
export default {
  ...
  methods: {
    ...
    getTongMews () {
      ...
      if (this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value !== null) {
        isNum = true
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 40) {
          num += 3
          this.BreathingPews = 3
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 39 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 30) {
          num += 2
          this.BreathingPews = 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 29 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 20) {
          num += 1
        ...
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 14 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 10) {
          num += 1
          this.BreathingPews = 1
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 9 && parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) >= 6) {
          num += 2
          this.BreathingPews = 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT1'].Items[0].Value) <= 5) {
          num += 3
          this.BreathingPews = 3
        }
      }
      ...
      if (this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value !== null) {
        isNum = true
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 190) {
          num += 3
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 189 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 160) {
          num += 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 159 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 120) {
          num += 1
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 119 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 90) {
          num += 0
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 89 && parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) >= 80) {
          num += 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT5'].Items[0].Value) <= 79) {
          num += 3
        }
      }
      // mach
      ...
      if (this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value !== '' && this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value !== null) {
        isNum = true
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 150) {
          num += 3
          this.BloodVesselPews = 3
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 149 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 130) {
          num += 2
          this.BloodVesselPews = 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 129 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 100) {
          num += 1
          this.BloodVesselPews = 1
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 99 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 60) {
          num += 0
          this.BloodVesselPews = 0
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 59 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 50) {
          num += 1
          this.BloodVesselPews = 1
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) <= 49 && parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) >= 40) {
          num += 2
          this.BloodVesselPews = 2
        }
        if (parseInt(this.MASTERDATA['IPDPEWSPDT8'].Items[0].Value) < 40) {
          num += 3
          this.BloodVesselPews = 3
        }
      }
