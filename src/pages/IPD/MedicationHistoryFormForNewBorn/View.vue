<template>
  <Vcollapse @getData="getData()" ref="Vcollapse">
    ...
    <template slot='content' v-if="hasData">
      <MedicationHistoryFormDex :viewOnly="true" :VisitId="VisitId" :VisitType="_VisitType"/>
    </template>
  </Vcollapse>
</template>
<script>
import MedicationHistoryFormDex from './index.vue'

export default {
  name: 'IPDMedicationHistoryFormPediatricPatient',
