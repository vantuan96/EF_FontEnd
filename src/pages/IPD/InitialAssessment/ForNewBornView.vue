<template>
  <Vcollapse @getData="getData()" ref="Vcollapse" class="disable_ccp4">
    ...
    <template slot='info'>
      <!-- <span class="pull-right" style="padding: 8px;font-size: 14px;">{{__t('Chỉnh sửa lần cuối bởi')}} <AdInfo :ad="FormV2 ? FormV2.UpdatedBy : Form.UpdatedBy" /> {{__t('lúc')}} {{getFTime(Form.UpdatedAt)}}</span> -->
...
export default {
  name: 'IPDInitialAssessmentForNeonatal',
