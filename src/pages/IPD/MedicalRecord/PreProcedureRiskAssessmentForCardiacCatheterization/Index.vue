<template>
  <div class="main-content">
    <div class="box box-table" style="border: none;">
        ...
        <div style="display: flex; margin-top: 12px; border: 1px dashed #ccc; width: 100%" class="container">
          <table style="width: 50%; margin-bottom: 12px;">
            <tr v-if="MASTERDATA['IPDPPRAFCC01']">
              <td>
                <span class="v-checkbox" align="center" v-if="MASTERDATA['IPDPPRAFCC01']">
                  <input :disabled="readOnly" type="checkbox" :id="'IPDPPRAFCC01'" v-model="MASTERDATA['IPDPPRAFCC01'].Items[0].Value">
                  <label class="ml-5" :for="'IPDPPRAFCC01'">{{__labelEnAndVi(MASTERDATA['IPDPPRAFCC01'])}}</label>
                </span>
              </td>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC03']">
              <td>
                <span class="v-checkbox" align="center">
                  ...
                  <label class="ml-5" :for="'IPDPPRAFCC03'">{{__labelEnAndVi(MASTERDATA['IPDPPRAFCC03'])}}</label>
                </span>
              </td>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC05']">
              <td>
                <span class="v-checkbox" align="center">
                  ...
                  <label class="ml-5" :for="'IPDPPRAFCC05'">{{__labelEnAndVi(MASTERDATA['IPDPPRAFCC05'])}}</label>
                </span>
              </td>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC07']">
              <td>
                <span class="v-checkbox" align="center">
                  ...
                  <label class="ml-5" :for="'IPDPPRAFCC07'">{{__labelEnAndVi(MASTERDATA['IPDPPRAFCC07'])}}</label>
                </span>
              </td>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC09']">
              <td>
                <span class="v-checkbox" align="center">
                  ...
                  <label class="ml-5" :for="'IPDPPRAFCC09'">{{__labelEnAndVi(MASTERDATA['IPDPPRAFCC09'])}}</label>
                </span>
              </td>
            </tr>
          </table>
            ...
            <tr v-if="MASTERDATA['IPDPPRAFCC11']">
              <td>
                <span class="v-checkbox" align="center">
                  ...
                  <label class="ml-5" :for="'IPDPPRAFCC11'">{{__labelEnAndVi(MASTERDATA['IPDPPRAFCC11'])}}</label>
                </span>
              </td>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC13']">
              <td>
                <span class="v-checkbox" align="center">
                  ...
                  <label class="ml-5" :for="'IPDPPRAFCC13'">{{__labelEnAndVi(MASTERDATA['IPDPPRAFCC13'])}}</label>
                </span>
              </td>
            </tr>
            ...
            <tr v-if="MASTERDATA['IPDPPRAFCC17']">
              <td>
                <span class="v-checkbox" align="center">
                  ...
                  <label class="ml-5" :for="'IPDPPRAFCC17'">{{__labelEnAndVi(MASTERDATA['IPDPPRAFCC17'])}}</label>
                </span>
              </td>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC19']">
              <td>
                <span class="v-checkbox" align="center" style="display: flex">
                  <input :disabled="readOnly" type="checkbox" :id="'IPDPPRAFCC19'" v-model="MASTERDATA['IPDPPRAFCC19'].Items[0].Value">
                  <label style="margin-top:auto; margin-bottom: auto;" class="ml-5" :for="'IPDPPRAFCC19'">{{__labelEnAndVi(MASTERDATA['IPDPPRAFCC19'])}}:</label>
                  <textarea-autosize style="margin-top: 10px; max-width: 400px" :placeholder="__t('Nhập')" rows="1" v-if="MASTERDATA['IPDPPRAFCC19'] && MASTERDATA['IPDPPRAFCC19'].Items[0].Value" :readOnly="readOnly" class="form-control"  v-model="MASTERDATA['IPDPPRAFCC19'].Items[1].Value"/>
                </span>
              </td>
            </tr>
          </table>
          ...
          <table style="width: 20%; margin: 12px;">
            <tr v-if="MASTERDATA['IPDPPRAFCC21']">
              <div class="form-group">
                ...
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC21'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC23']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC23'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC23'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC25']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC25'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC25'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC27']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC27'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC27'].Items[0].Value">
              </div>
            </tr>
          </table>
          <table style="width: 20%; margin: 12px;">
            <tr v-if="MASTERDATA['IPDPPRAFCC29']">
              <div class="form-group">
                ...
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC29'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC31']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC31'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC31'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC33']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC33'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC33'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC35']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC35'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC35'].Items[0].Value">
              </div>
            </tr>
          </table>
          <table style="width: 20%; margin: 12px;">
            <tr v-if="MASTERDATA['IPDPPRAFCC37']">
              <div class="form-group">
                ...
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC37'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC39']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC39'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC39'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC41']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC41'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC41'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC43']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC43'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC43'].Items[0].Value">
              </div>
            </tr>
          </table>
          <table style="width: 20%; margin: 12px;">
            <tr v-if="MASTERDATA['IPDPPRAFCC45']">
              <div class="form-group">
                ...
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC45'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC47']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC47'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC47'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC234']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC234'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC234'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC49']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC49'])}}</label>
                <input :placeholder="__t('N/A')" :disabled="true" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC49'].Items[0].Value">
              </div>
            </tr>
          </table>
          <table style="width: 20%; margin: 12px;">
            <tr v-if="MASTERDATA['IPDPPRAFCC51']">
              <div class="form-group">
                ...
                <input :placeholder="__t('N/A')" :disabled="true" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC51'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC53']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC53'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="true" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC53'].Items[0].Value">
              </div>
            </tr>
            <tr v-if="MASTERDATA['IPDPPRAFCC55']">
              <div class="form-group">
                <label style="margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC55'])}}</label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" v-model="MASTERDATA['IPDPPRAFCC55'].Items[0].Value">
              </div>
            </tr>
            <tr>
              <div class="form-group">
                <label style="margin-right: 10px;"></label>
                <input :placeholder="__t('Nhập')" :disabled="readOnly" class="form-control" type="text" style="visibility: hidden">
              </div>
            </tr>
          </table>
        </div>
        <div style="display: flex; margin-top: 12px;">
          <table style="width: 100%" class="table standing-order-tbl td-re">
            <tr class="text-center">
              ...
              <td style="width: 5%">{{__t("Có")}}</td>
              <td style="width: 5%">{{__t("Không")}}</td>
              <td style="width: 5%">{{__t("N/A")}}</td>
            </tr>
            <tr>
              ...
              <td>
                <div>
                  ...
                  <span v-if="MASTERDATA['IPDPPRAFCC61'].Items[0].Value" style="display: flex">
                    ...
                    <textarea-autosize :placeholder="__t('Nhập')" :readOnly="readOnly" style="max-width: 500px" class="form-control" rows="1" v-model="MASTERDATA['IPDPPRAFCC65'].Items[0].Value"/>
                  </span>
                </div>
              </td>
              ...
              <td>
                <div>
                  ...
                  <span v-if="MASTERDATA['IPDPPRAFCC99'].Items[0].Value" style="display: flex">
                    ...
                    <textarea-autosize :placeholder="__t('Nhập')" :readOnly="readOnly" style="max-width: 300px" class="form-control" rows="1"  v-model="MASTERDATA['IPDPPRAFCC103'].Items[0].Value"/>
                  </span>
                </div>
              </td>
            ...
            <tr v-if="MASTERDATA['IPDPPRAFCC105']">
              <td>
                <div style="display: flex; align-items: baseline;">
                  ...
                  <VNumberInput @change="handleChange" style="max-width: 200px; margin: 0px 10px;" :placeholder="__t('Nhập')" :decimal="true"  :readonly="readOnly" class="input-para" v-model="MASTERDATA['IPDPPRAFCC105'].Items[0].Value"/>
                  <p>%</p>
                </div>
                <div style="display: flex; align-items: baseline; margin-top: 12px;">
                  <p >{{__label(MASTERDATA['IPDPPRAFCC107'])}}</p>
                  <textarea-autosize :placeholder="__t('Nhập')" :readOnly="readOnly" style="max-width: 200px; margin: 0px 10px;" class="form-control" rows="1" v-model="MASTERDATA['IPDPPRAFCC107'].Items[0].Value"/>
                </div>
                <p style="margin-top: 10px">{{__t('Đánh giá nguy cơ chảy máu: Thấp (&#60;= 2%), Trung bình (> 2% &#60;= 6.5%), Cao (> 6.5%)')}}</p>
              </td>
              <td style="width: 5%"></td>
              <td style="width: 5%"></td>
              <td style="width: 5%"></td>
              ...
              <td>
                <div>
                  ...
                  <span v-if="MASTERDATA['IPDPPRAFCC109'].Items[0].Value" style="display: flex">
                    ...
                    <textarea-autosize :placeholder="__t('Nhập')" :readOnly="readOnly" style="max-width: 300px" class="form-control" rows="1" v-model="MASTERDATA['IPDPPRAFCC113'].Items[0].Value"/>
                  </span>
                </div>
              </td>
            ...
            <tr v-if="MASTERDATA['IPDPPRAFCC139']">
              <td>
                <div style="display: flex; align-items: baseline;">
                  ...
                  <VNumberInput style="max-width: 200px; margin: 0px 10px;" :placeholder="__t('Nhập')" :decimal="true"  :readonly="readOnly" class="input-para" v-model="MASTERDATA['IPDPPRAFCC139'].Items[0].Value"/>
                  <p>{{__t("điểm ")}}</p>
                </div>
                <div style="display: flex; align-items: baseline; margin-top: 10px;">
                  <p style="margin-top: 12px;">{{__label(MASTERDATA['IPDPPRAFCC141'])}}</p>
                  <VNumberInput style="max-width: 200px; margin: 0px 10px;" :placeholder="__t('Nhập')" :decimal="true"  :readonly="readOnly" class="input-para" v-model="MASTERDATA['IPDPPRAFCC141'].Items[0].Value"/>
                  <p>%</p>
                </div>
                <div style="display: flex; align-items: baseline; margin-top: 10px;">
                  <p >{{__label(MASTERDATA['IPDPPRAFCC143'])}}</p>
                  <VNumberInput style="max-width: 200px; margin: 0px 10px;" :placeholder="__t('Nhập')" :decimal="true"  :readonly="readOnly" class="input-para" v-model="MASTERDATA['IPDPPRAFCC143'].Items[0].Value"/>
                  <p>%</p>
                </div>
              </td>
              <td style="width: 5%"></td>
            ...
            <tr v-if="MASTERDATA['IPDPPRAFCC145']">
              <td>
                <div style="display: flex; align-items: baseline;">
                  ...
                  <VNumberInput style="max-width: 200px; margin: 0px 10px;" :placeholder="__t('Nhập')" :decimal="true"  :readonly="readOnly" class="input-para" v-model="MASTERDATA['IPDPPRAFCC145'].Items[0].Value"/>
                  <p>ml</p>
                </div>
              </td>
              <td style="width: 5%"></td>
              ...
              <td>
                <div>
                  ...
                  <span v-if="MASTERDATA['IPDPPRAFCC171'].Items[0].Value" style="display: flex">
                    ...
                    <textarea-autosize :placeholder="__t('Nhập')" :readOnly="readOnly" style="max-width: 200px; margin: 0px 10px;" class="form-control" rows="1" v-model="MASTERDATA['IPDPPRAFCC175'].Items[0].Value"/>
                  </span>
                </div>
              </td>
            ...
            <tr v-if="MASTERDATA['IPDPPRAFCC177']">
              <td>
                <div>
                  ...
                  <span v-if="MASTERDATA['IPDPPRAFCC177'].Items[0].Value" style="display: flex">
                    <p style="margin-top: auto; margin-bottom: auto; margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC181'])}}</p>
                    <textarea-autosize :placeholder="__t('Nhập')" :readOnly="readOnly" style="max-width: 500px; margin: 0px 10px;" class="form-control" rows="1" v-model="MASTERDATA['IPDPPRAFCC181'].Items[0].Value"/>
                  </span>
                   <span v-if="MASTERDATA['IPDPPRAFCC177'].Items[0].Value" style="display: flex; margin-top: 12px;">
                    <p style="margin-top: auto; margin-bottom: auto; margin-right: 10px;">{{__label(MASTERDATA['IPDPPRAFCC183'])}}</p>
                    <textarea-autosize :placeholder="__t('Nhập')" :readOnly="readOnly" style="max-width: 500px; margin: 0px 10px;" class="form-control" rows="1" v-model="MASTERDATA['IPDPPRAFCC183'].Items[0].Value"/>
                  </span>
                </div>
              </td>
      ...
      <div v-else class="text-center p20">
        <p>{{__t('Vui lòng chọn sử dụng Đánh giá nguy cơ')}}</p>
        <button class="btn btn-warning" @click="confirmPopup" v-if="NeedCreateRecordExtenstion">{{__t('Tạo mới')}}</button>
        <button class="btn btn-warning" @click="gotoPart2" v-else>{{__t('Đi đến')}}</button>
      </div>
    </div>
        ...
        <div style="float: right; width: 500px;">
          <div class="col-md-8">
            <div class="form-group1">
              <button v-if="!readOnly" class="btn v-yellow-btn pull-right btn-block hvr-ripple-out" type="button" v-shortkey="['ctrl', 's']" @click="save()"><i class="fa fa-floppy-o" aria-hidden="true"></i> {{__t('btn.luu')}}</button>
            </div>
          </div>
        </div>
      </template>
...
export default {
  ...
  watch: {
    MASTERDATA: {
      handler () {
        if (this.MASTERDATA['IPDPPRAFCC19'] && !this.MASTERDATA['IPDPPRAFCC19'].Items[0].Value) {
          this.MASTERDATA['IPDPPRAFCC19'].Items[1].Value = ''
        }

        if (this.MASTERDATA['IPDPPRAFCC61'] && !this.MASTERDATA['IPDPPRAFCC61'].Items[0].Value) {
          this.MASTERDATA['IPDPPRAFCC65'].Items[0].Value = ''
        }

        if (this.MASTERDATA['IPDPPRAFCC99'] && !this.MASTERDATA['IPDPPRAFCC99'].Items[0].Value) {
          this.MASTERDATA['IPDPPRAFCC103'].Items[0].Value = ''
        }

        if (this.MASTERDATA['IPDPPRAFCC171'] && !this.MASTERDATA['IPDPPRAFCC171'].Items[0].Value) {
          this.MASTERDATA['IPDPPRAFCC175'].Items[0].Value = ''
        }

        if (this.MASTERDATA['IPDPPRAFCC109'] && !this.MASTERDATA['IPDPPRAFCC109'].Items[0].Value) {
          this.MASTERDATA['IPDPPRAFCC113'].Items[0].Value = ''
        }

        if (this.MASTERDATA['IPDPPRAFCC177'] && !this.MASTERDATA['IPDPPRAFCC177'].Items[0].Value) {
          this.MASTERDATA['IPDPPRAFCC181'].Items[0].Value = ''
          this.MASTERDATA['IPDPPRAFCC183'].Items[0].Value = ''
        }
      },
      deep: true
    }
  ...
  methods: {
    handleChange (data) {
      if (data && this.MASTERDATA['IPDPPRAFCC107'] && this.MASTERDATA['IPDPPRAFCC109']) {
        let str = this.MASTERDATA['IPDPPRAFCC107'].Items[0].Value
        if (parseFloat(data) > 6.5) {
          ...
          if (str === this.__t('Trung bình ') || str === this.__t('Thấp ') || !str) {
            str = this.__t('Cao ')
          }
        } else if (parseFloat(data) > 2 && parseFloat(data) <= 6.5) {
          this.MASTERDATA['IPDPPRAFCC109'].Items[0].Value = false
          this.MASTERDATA['IPDPPRAFCC109'].Items[1].Value = true
          this.MASTERDATA['IPDPPRAFCC109'].Items[2].Value = false
          if (str === this.__t('Cao ') || str === this.__t('Thấp ') || !str) {
            str = this.__t('Trung bình ')
          }
        } else if (parseFloat(data) >= 0 && parseFloat(data) <= 2) {
          this.MASTERDATA['IPDPPRAFCC109'].Items[0].Value = false
          this.MASTERDATA['IPDPPRAFCC109'].Items[1].Value = true
          this.MASTERDATA['IPDPPRAFCC109'].Items[2].Value = false
          if (str === this.__t('Cao ') || str === this.__t('Trung bình ') || !str) {
            str = this.__t('Thấp ')
          }
        }
        this.MASTERDATA['IPDPPRAFCC107'].Items[0].Value = str
      }
      if (!data && this.MASTERDATA['IPDPPRAFCC107'] && this.MASTERDATA['IPDPPRAFCC109']) {
        if (this.MASTERDATA['IPDPPRAFCC107'].Items[0].Value === this.__t('Cao ') ||
          this.MASTERDATA['IPDPPRAFCC107'].Items[0].Value === this.__t('Trung bình ') ||
          this.MASTERDATA['IPDPPRAFCC107'].Items[0].Value === this.__t('Thấp ')) {
          this.MASTERDATA['IPDPPRAFCC107'].Items[0].Value = ''
        }
        this.MASTERDATA['IPDPPRAFCC109'].Items[0].Value = false
        this.MASTERDATA['IPDPPRAFCC109'].Items[1].Value = false
    ...
    getData () {
      ...
      new PreProcedureRiskAssessmentForCardiacCatheterization().find(url).then(response => {
        ...
        if (response.Confirm.Doctor.ConfirmAt !== null) {
          this.readOnly = true
        }
    ...
    confirmPopup () {
      this.$modal.show('dialog', {
        ...
        text: this.__t('Tạo mới Đánh giá nguy cơ trước thủ thuật đối với bệnh nhân can thiệp tim mạch'),
    ...
    create () {
      new PreProcedureRiskAssessmentForCardiacCatheterization({}, this._VisitId).update(this._VisitId, {}, `/Create/` + this.MedicalRecordFormCode + `/PreProcedureRiskAssessmentForCardiacCatheterization/`).then(response => {
        this.reload()
      })
    },
    ...
    save () {
      ...
      let url = `/Update/` + this.MedicalRecordFormCode + `/PreProcedureRiskAssessmentForCardiacCatheterization/${this._VisitId}`
      return new PreProcedureRiskAssessmentForCardiacCatheterization().update(url, this.DataSubmit).then((response) => {
        this.toastedSuccess()
        this.reload()
        this.saved = true
      })
    ...
    async confirm () {
      ...
      let url = `/Confirm/` + this.MedicalRecordFormCode + `/PreProcedureRiskAssessmentForCardiacCatheterization/${this._VisitId}`
      new PreProcedureRiskAssessmentForCardiacCatheterization({}, this._VisitType)
        .update(url, this.user)
        .then((response) => {
    ...
    gotoPart2 () {
      if (this.$route.meta.type === 'CardiovascularForm') {
        this.$router.push({name: `IPDCardiovascularFormPart2`, params: { Id: this._VisitId }, query: {componentId: 'MedicalRecord-part2-block6'}})
      } else {
        this.$router.push({name: `IPD${this.getNameType()}Part2`, params: { Id: this._VisitId }, query: {componentId: 'MedicalRecord-part2-block6'}})
      }
    }
  }
}
