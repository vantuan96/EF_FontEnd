    ...
    <template slot='content' v-if="hasData">
      <div class="v-tab">
        <ul id="AmbulanceRunReportTab" class="nav nav-tabs" role="tablist">
          ...
          <li v-if="Version === '2' || routeType === 'CardiovascularForm' || FormV2.Version === '2'" role="presentation" :class="activeClass('PreProcedureRiskAssessmentForCardiacCatheterization')">
...
export default {
  ...
  mounted () {
    ...
    console.log('FormV2', this.FormV2.Version)
