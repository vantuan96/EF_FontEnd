  ...
  <table width="100%">
      <tr >
        ...
        <td class="text-center">
          <div class="font20 font-bold text-center" style="margin-left:-145px">
            YÊU CẦU KHÔNG HỒI SINH TIM PHỔI
          </div>
          <div class="font20 font-bold text-center" style="font-style: italic; margin-left:-160px">
    ...
    <div class="box form-content">
      <div class="box-body">
        ...
        <div style="margin-top: 8px; margin-left:5px">{{data.Specialty.ViName}}</div>
        </div>
      ...
      <!-- thời gian -->
      <div style="display:flex;">
        <div class="mt-10"><p v-html="$t('Giờ, Ngày/Time, Date:')"></p></div>
