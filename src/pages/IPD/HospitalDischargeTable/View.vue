<template>
  <Vcollapse @getData="getData()" ref="Vcollapse">
    ...
    <template slot='content' v-if="hasData">
      <HospitalDischargeTable :viewOnly="true" :VisitId="VisitId" :VisitType="_VisitType"/>
    </template>
  </Vcollapse>
</template>
<script>
import HospitalDischargeTable from './index.vue'

export default {
  name: 'IPDDischargePreparationChecklist',
