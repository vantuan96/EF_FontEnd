<template>
 <div class="MedicationHistoryForm-table">
  ...
  <!-- table 1 -->
   <table class="table observation-table" v-if="!nullTable">
     <thead>
       ...
       <tr>
         <th class="text-center" width="50px">{{__t('MedicationHistoryForm.label4')}}</th>
...
export default {
  name: 'MedicationHistoryForm-table',
  data () {
    return {
      option1: [
        {
  ...
  created () {
    ...
    EventBus.$on('SaveMedicationHistoryForm', this.handleSubmitConfirm)
  },
  beforeDestroy () {
