<template>
  <Vcollapse @getData="getData()" ref="Vcollapse">
    ...
    <template slot='content' v-if="hasData">
      <ConsentForOperation :viewOnly="true" :VisitId="VisitId" :VisitType="_VisitType"/>
    </template>
  </Vcollapse>
</template>
<script>
import ConsentForOperation from './Index.vue'

export default {
  name: 'EOCConsentForOperationOrrProcedure',
