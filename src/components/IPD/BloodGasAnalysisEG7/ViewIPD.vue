...
<script>
import Item from '@/pages/IPD/BloodGasAnalysisEG7/Item.vue'
...
export default {
  ...
  methods: {
    ...
    getData () {
      new API().find('GetList/' + this._VisitType + '/A03_165_061222_V/' + this._VisitId + '?hidemsg=' + true).then(response => {
