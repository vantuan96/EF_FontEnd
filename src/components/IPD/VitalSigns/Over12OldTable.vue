    ...
    <div class="box-table mrb30">
      ...
      <!-- <table> -->
        ...
        <tr>
          ...
          <th class="table-head table-head__sticky--row2">PEWS</th>
          <td class="text-center" v-for="(item, index) in listItems" :key="index">
        ...
        <tr class="text-center">
          <th class="font-normal table-head__sticky table-head__sticky--row1">30-35</th>
          <th class="font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
            <span v-if="item >= 30 && item <= 35">{{item}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
        ...
        <tr class="text-center">
          ...
          <th class="font-normal table-head__sticky table-head__sticky--row1">&#8805; 190</th>
          <th class="font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 190">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="font-normal table-head__sticky table-head__sticky--row1">160-189</th>
          <th class="font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 160 && item.HuyetApToiDa <= 189">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="font-normal table-head__sticky table-head__sticky--row1">120-159</th>
          <th class="font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 120 && item.HuyetApToiDa <= 159">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="font-normal table-head__sticky table-head__sticky--row1">90-119</th>
          <th class="font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
        ...
        <!-- Mạch -->
        <tr class="text-center">
          <th class="no-wrap text-center table-head__sticky" rowspan="15">
            <b>Mạch (*)</b>
...
.table-head__sticky {
  position: sticky !important;
  box-shadow: 10px 0 5px -2px #888 !important;
  left: 0;
  z-index: 1;
}
