<template>
  <div class="page-table-vital">
    <!-- page chart -->
    <!-- <page-chart :FormType="'IPDPediatricVitalSign'" :FormCode='FormCode' :viewOnly="viewOnly" :parameters="parameters" :DataChart="DataChart" :VisitId="VisitId"/> -->
    <page-chart class="d-none" :FormType="'IPDPediatricVitalSign'" :FormCode='FormCode' :viewOnly="false" :parameters="parameters" :DataChart="DataChart" :VisitId="VisitId"/>
    <!-- box date time -->
...
import PageChart from './PediatricChart.vue'
...
export default {
  name: 'PageTable',
  components: { Intervention, VDateTimePicker, VSelect, PageChart },
