    ...
    <div class="box-table mrb30">
      ...
      <!-- <table> -->
        ...
        <tr class="text-center">
          <th class="text-center no-wrap table-head__sticky" rowspan="9">
            <b>Nhịp thở (*)</b>
          ...
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8805; 55</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in DataChart.NhipThoMEWS" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">10-14</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in DataChart.NhipThoMEWS" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8804; 9</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in DataChart.NhipThoMEWS" :key="index">
        ...
        <tr class="text-center">
          ...
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8805; 150</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">125-149</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 125 && item.HuyetApToiDa <= 149">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">110-124</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 110 && item.HuyetApToiDa <= 124">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">90-109</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 90 && item.HuyetApToiDa <= 109">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          ...
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item >= 80 && item.HuyetApToiDa <= 89">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8804; 79</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa <= 79">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <!-- Mạch -->
        <tr class="text-center">
          ...
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8805; 160</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in labelsMach" :key="index">
            <span v-if="item >= 160">{{item}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">60-69</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in labelsMach" :key="index">
            <span v-if="item >= 60 && item <= 69">{{item}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">50-59</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in labelsMach" :key="index">
            <span v-if="item >= 50 && item <= 59">{{item}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#60; 49</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in labelsMach" :key="index">
            <span v-if="item <= 49">{{item}}</span>
            <span v-else></span>
          </td>
        </tr>
        <!-- Thân nhiệt -->
        ...
        <tr class="text-center">
          ...
          <td v-for="(item, index) in listVitalSign" :key="index">
            <b v-if="item.BilanDich">{{`${item.BilanDich} ml`}}</b>
            <span v-else></span>
          </td>
        </tr>
      </table>
