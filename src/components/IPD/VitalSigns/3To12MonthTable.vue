    ...
    <div class="box-table mrb30">
      ...
      <!-- <table> -->
        ...
        <tr class="text-center">
          <th class="text-center no-wrap table-head__sticky" rowspan="12">
            <b>Nhịp thở (*)</b>
          ...
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8805; 65</th>
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">15-19</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8804; 14</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
            <span v-if="item <= 14">{{item}}</span>
            <span v-else></span>
          </td>
        </tr>
        <!-- SpO2 -->
        ...
        <tr class="text-center">
          ...
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8805; 130</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 130">{{item.HuyetApToiDa}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">110-129</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 110 && item.HuyetApToiDa <= 129">{{item.HuyetApToiDa}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">75-109</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 75 && item.HuyetApToiDa <= 109">{{item.HuyetApToiDa}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">61-74</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 61 && item.HuyetApToiDa <= 74">{{item.HuyetApToiDa}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8804; 60</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa <= 60">{{item.HuyetApToiDa}}</span>
            <span v-else></span>
          </td>
        </tr>
        <!-- Mạch -->
