    ...
    <div class="box-table mrb30">
      ...
      <!-- <table> -->
        ...
        <tr class="text-center">
          ...
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8805; 80</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">75-79</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">70-74</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">65-69</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">60-64</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">55-59</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">50-54</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">45-49</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">40-44</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">35-39</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">30-34</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">25-29</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">20-24</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8804; 19</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in labelsNhipTho" :key="index">
        ...
        <tr class="text-center">
          ...
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8805; 95</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">90 - 94</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">85-89</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8804; 84</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
        ...
        <!-- Huyet ap -->
        <tr class="text-center">
          <th class="no-wrap text-center table-head__sticky" rowspan="5">
            <b>Huyết áp</b>
            <p class="font-normal">(mmHg)</p>
          </th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8805; 120</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 120">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">90-119</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 90 && item.HuyetApToiDa <= 119">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">60-89</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 60 && item.HuyetApToiDa <= 89">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">51-59</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa >= 51 && item.HuyetApToiDa <= 59">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8804; 50</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in listVitalSign" :key="index">
            <span v-if="item.HuyetApToiDa <= 50">{{item.HuyetApToiDa}} {{item.HuyetApToiThieu ? `/ ${item.HuyetApToiThieu}` : ''}}</span>
            <span v-else></span>
          </td>
        </tr>
        <!-- Mạch -->
        <tr class="text-center">
          ...
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8805; 180</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">170-179</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in labelsMach" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">160-169</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in labelsMach" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">150-159</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in labelsMach" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">140-149</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in labelsMach" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">130-139</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in labelsMach" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">120-129</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in labelsMach" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">110-119</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in labelsMach" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">100-109</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in labelsMach" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">90-99</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in labelsMach" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">80-89</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in labelsMach" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">70-79</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in labelsMach" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8804; 69</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in labelsMach" :key="index">
        ...
        <tr class="text-center">
          ...
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#8805; 41</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">40-40.9</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in labelsThanNhiet" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">39-39.9</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in labelsThanNhiet" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">38.5-38.9</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in labelsThanNhiet" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">38-38.4</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in labelsThanNhiet" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">37-37.9</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in labelsThanNhiet" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">36-36.9</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">0</th>
          <td v-for="(item, index) in labelsThanNhiet" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">35.5-35.9</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">1</th>
          <td v-for="(item, index) in labelsThanNhiet" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">35-35.4</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">2</th>
          <td v-for="(item, index) in labelsThanNhiet" :key="index">
        ...
        <tr class="text-center">
          <th class="text-center font-normal table-head__sticky table-head__sticky--row1">&#60; 35</th>
          <th class="text-center font-normal table-head__sticky table-head__sticky--row2">3</th>
          <td v-for="(item, index) in labelsThanNhiet" :key="index">
