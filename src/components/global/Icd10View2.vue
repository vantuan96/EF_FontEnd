<template>
  <div style="margin-bottom: 8px; margin-top: 5px;" v-if="single">
    <span class="v-tags" v-if="icdNotNull && icdNotNull.length"><span class="v-tag">{{getLabel(icdNotNull[0])}}</span></span>
    <span class="v-tags" v-else><span class="v-tag" >N/A</span></span>
  </div>
  <div v-else style="margin-bottom: 8px; margin-top: 5px;">
