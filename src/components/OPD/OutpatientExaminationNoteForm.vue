<template>
  <div class="min-height-200">
    ...
    <template v-else>
      <template v-if="DataSubmit.Version === 2 && _VisitType === 'OPD'">
        <Ver2View :VisitId="_VisitId" :DataSubmit="DataSubmit" :MASTERDATA="MASTERDATA" :VisitTypeCode="VisitTypeCode" :VisitVersion="VisitVersion"/>
      </template>
      <template v-else>
        <div id="OutpatientExaminationNoteForm">
          ...
          <div class="box box-table">
            <div class="box-body">
              ...
              <md-input-text v-if="MASTERDATA['OPDOENCEF'] && DataSubmit.Clinic && DataSubmit.Clinic.Code === 'Normal'" v-model="MASTERDATA['OPDOENCEF']" :readonly="true"/>
            </div>
          </div>
          <div class="box box-table">
            <div class="box-body">
    ...
    <hr/>
    <p v-if="VisitVersion >= 12">A01_251_221222_V</p>
...
import Ver2View from '@/pages/OPD/OutpatientExaminationNote/View/Ver2View.vue'

const EndOsCopy = () => import('@/components/Endoscopy.vue')
export default {
  name: 'OutpatientExaminationNoteVIEW',
  mixins: [],
  props: ['DataSubmit', 'MASTERDATA', 'VisitTypeCode', 'VisitType', 'VisitId'],
  components: {
    Diorpt,
