    ...
    <div class="min-height-200">
      ...
      <template v-else>
        <div id="OutpatientExaminationNoteForm">
              ...
              <div class="row">
                <div class="col-md-2 col-25" v-if="MASTERDATA['OPDOENHEI']">
                  <div class="form-group" :data="item" :key="index"  v-for="(item, index) in MASTERDATA['OPDOENHEI'].Items">
                    <label>{{__label(item)}} <i class="unit-label">{{item.Note}}</i></label>
                    <div class="fake-input disable">{{DataSubmit.Customer.Height || item.Value || 'N/A'}}</div>
                    <!-- <div class="fake-input disable">{{item.Value || 'N/A'}}</div> -->
                  </div>
                </div>
                <div class="col-md-2 col-25" v-if="MASTERDATA['OPDOENWEI']">
                  <div class="form-group" :data="item" :key="index"  v-for="(item, index) in MASTERDATA['OPDOENWEI'].Items">
                    <label>{{__label(item)}} <i class="unit-label">{{item.Note}}</i></label>
                    <div class="fake-input disable">{{DataSubmit.Customer.Weight || item.Value || 'N/A'}}</div>
                    <!-- <div class="fake-input disable">{{item.Value || 'N/A'}}</div> -->
                  </div>
                </div>
                <div class="col-md-2 col-25" v-if="MASTERDATA['OPDOENWEI']">
          ...
          <div class="box box-table" v-if="checkSetupClinic('CHUNG') && Version === 2 || checkEoc && Version === 2">
            <div class="box-body">
              <label>
              ...
              <list-of-current-medications
                ...
                :Type="(VisitTypeCode || 'OPD') + '-PatientMedicationList'"
                :VisitTypeGroupCode="VisitTypeCode || 'OPD'"
                :RealOnly="true"
              />
            </div>
          </div>
          ...
          <div class="box box-table">
            <div class="box-body">
              ...
              <icd10-view v-if="MASTERDATA['OPDOEN659'] && Version === 2" class="mrb10" v-model="MASTERDATA['OPDOEN659'].Items[0].Value" />
              ...
              <div class="row">
                <div class="col-md-12" v-if="MASTERDATA['OPDOENDD0']">
                  <div class="form-group">
                    ...
                    <icd10-view v-if="MASTERDATA['OPDOEN661'] && Version === 2" class="mrb10" v-model="MASTERDATA['OPDOEN661'].Items[0].Value" />
                ...
                <div class="col-md-12" v-if="MASTERDATA['OPDOENDOR']">
                  <div class="form-group">
                    ...
                    <div :data="item" :key="index"  v-for="(item, index) in MASTERDATA['OPDOENDOR'].Items">
                      <p class="fake-input disable" style="margin: 0; width:200px">{{item.Value || 'N/A'}}</p>
                    </div>
                  </div>
                </div>
              </div>
