<template>
  <div>
    <div :id="idConfirm" class="d-flex row">
      <div
    ...
    <modal :name="idConfirm" transition="pop-out" id="doctor-login" height="auto" :clickToClose="false">
      <div class="box v-model-content-popup">
        ...
        <div class="form-confirm">
          ...
          <div class="row">
            <div class="col-xs-6">
              <button type="button" class="btn btn-block v-white-btn" @click="$modal.hide(idConfirm)">{{__t('Thoát')}}</button>
            </div>
            <div class="col-xs-6">
...
export default {
  ...
  watch: {
    ...
    hideConfirm: function (value) {
      this.$modal.hide(this.idConfirm)
    }
  },
  computed: {
    getTitle () {
  ...
  methods: {
    ...
    showDoctorConfirm (item, title) {
      ...
      this.$modal.show(this.idConfirm)
    },
    getConfirm () {
